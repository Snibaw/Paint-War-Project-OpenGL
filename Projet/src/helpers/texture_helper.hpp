...
public:
	...
	void set_filtering_params( const GLenum mag_filter = GL_LINEAR, GLenum min_filter = GL_LINEAR_MIPMAP_LINEAR, const float max_anisotropy = 16.0f,const GLenum wrap_s = GL_REPEAT, const GLenum wrap_t = GL_REPEAT);
